...
Where possible, training and/or validation samples can (and for improved 
accuracy and reliability should be) generated from groundtruth data. However, 
given the wide extent of the study areas, and the inaccessibility of some of 
these areas due to an armed conflict, creation of training and validation 
samples from the images was most feasible. The generation 
