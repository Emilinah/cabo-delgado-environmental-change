---
title: "Land use land cover change due to energy transition-induced resource extraction
...
### Satellite images of our areas of interest
...
The classified images of the study and projects' areas include a 'count' column 
which includes area in pixels taken up by each lulc class. We multiply these 
areas by 0.0009 to convert them to square kilometers. We use the changes in 
these lulc areas for each location over the two time stamps (2021/2020 & 2015) 
to determine the change in lulc due to energy transition-induced resource 
...
We assess the accuracy of our land use land cover classification.
